            ...
            >
              <div className="flex items-center p-3 px-5">
                ...
                <div className="pr-3 md:pr-5 md:mr-2 md:pl-2">
                  ...
                  <div className="text-neutral-500 max-md:text-[14px] text-[16px] mt-1">
            ...
            <form action="">
              <div className="grid max-md:grid-rows-2 md:grid-cols-2">
                <dl>
                  <dd>
                    <input
                      className="h-12 focus:outline-none max-md:rounded-md md:rounded-s-md right-0 w-full placeholder:text-[16px] pl-3 pr-2"
          ...
          <div className="my-24 md:my-32">
            ...
            <div className="flex flex-wrap items-center justify-between">
              <img
                ...
                alt="Stripe logo"
                height="44"
                className="my-3 transition duration-150 ease-in scale-90 cursor-pointer hover:contrast-200 hover:-translate-y-1"
              />
              <img
              ...
              <img
                ...
                height="44"
                className="my-3 w-[200px] transition duration-150 ease-in cursor-pointer hover:contrast-200 hover:-translate-y-1"
              />
              <img
