      ...
      <div className="flex space-x-3 md:pl-10 md:space-x-10">
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <span className="absolute top-0 left-0 w-full h-full home-campaign-glowing-icon-glow-1 z-3"></span>
          </motion.div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex justify-between md:space-x-10 max-md:flex-col">
          ...
          >
            <div className="flex-col flex-1 p-8 md:flex sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
              <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
                <span className="font-semibold text-white">GitHub Mobile</span>{" "}
