...
const Footer = (props: Props) => {
  return (
    <div className="relative break-words footer pt-14 ">
      <div className="max-w-[1280px] mx-auto relative z-[2] overflow-hidden">
        <div className="flex flex-col px-4 py-10 mb-8 space-x-6 lg:flex-row">
          ...
          <div className="grid justify-between w-full grid-cols-2 gap-6 lg:flex md:grid-cols-4">
