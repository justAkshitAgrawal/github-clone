      ...
      <motion.div className="flex space-x-3 md:pl-7 md:space-x-10">
        <div className="flex flex-col items-center">
          ...
          >
            ...
            <span className="absolute top-0 left-0 w-full h-full home-campaign-glowing-icon-glow-3 z-3"></span>
          </motion.div>
          <motion.div
            initial={{ height: 0 }}
        ...
        <HoverCard backgroundColor="#939aff" direction="" left="0">
          <div className="overflow-auto md:flex flex-col md:space-y-20 flex-1 py-20 md:p-10 p-5 my-6    justify-between md:min-w-[400px]">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="font-medium text-white">GitHub Sponsors</span>{" "}
      ...
      <div className="flex flex-col gap-10 md:flex-row ">
        <HoverCard backgroundColor="#939aff" direction="flex-col" left="0">
          <div className="flex-col flex-1 p-8 md:flex sm:p-10 lg:py-16 lg:pl-16 lg:pr-32">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="font-semibold text-white">Dependabot</span> makes
        ...
        <HoverCard backgroundColor="#939aff" direction="flex-col" left="-400px">
          <div className="flex-col flex-1 p-8 md:flex sm:p-10 lg:py-16 lg:pl-16 lg:pr-32 ">
            <p className=" text-xl md:text-2xl mb-6 font-medium text-[#7d8590]">
              <span className="font-semibold text-white">Code scanning</span>is
